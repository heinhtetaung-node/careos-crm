  ...
  switch (n2.type) {
    ...
    case NodeType$3.Element: {
      ...
      if (n2.isSVG) {
        ...
        if (n2.isCustom && ((_a2 = doc.defaultView) == null ? void 0 : _a2.customElements) && !doc.defaultView.customElements.get(n2.tagName))
          doc.defaultView.customElements.define(n2.tagName, class extends doc.defaultView.HTMLElement {
          });
...
function rebuild(n2, options) {
  const { doc, onVisit, hackCss = true, afterAppend, cache, mirror: mirror2 = new Mirror() } = options;
...
class BaseRRDocument extends BaseRRNode {
  constructor(...args) {
    super(args);
    __publicField2(this, "nodeType", NodeType$2.DOCUMENT_NODE);
  ...
  get documentElement() {
    return this.childNodes.find((node2) => node2.RRNodeType === NodeType$1.Element && node2.tagName === "HTML") || null;
  }
  get body() {
    var _a2;
    return ((_a2 = this.documentElement) == null ? void 0 : _a2.childNodes.find((node2) => node2.RRNodeType === NodeType$1.Element && node2.tagName === "BODY")) || null;
  }
  get head() {
    var _a2;
    return ((_a2 = this.documentElement) == null ? void 0 : _a2.childNodes.find((node2) => node2.RRNodeType === NodeType$1.Element && node2.tagName === "HEAD")) || null;
  }
  get implementation() {
    return this;
  }
...
class BaseRRDocumentType extends BaseRRNode {
  constructor(qualifiedName, publicId, systemId) {
    super();
    __publicField2(this, "nodeType", NodeType$2.DOCUMENT_TYPE_NODE);
...
class BaseRRElement extends BaseRRNode {
  constructor(tagName) {
    super();
    __publicField2(this, "nodeType", NodeType$2.ELEMENT_NODE);
...
class BaseRRText extends BaseRRNode {
  constructor(data) {
    super();
    __publicField2(this, "nodeType", NodeType$2.TEXT_NODE);
...
class BaseRRComment extends BaseRRNode {
  constructor(data) {
    super();
    __publicField2(this, "nodeType", NodeType$2.COMMENT_NODE);
...
class BaseRRCDATASection extends BaseRRNode {
  constructor(data) {
    ...
    __publicField2(this, "nodeType", NodeType$2.CDATA_SECTION_NODE);
