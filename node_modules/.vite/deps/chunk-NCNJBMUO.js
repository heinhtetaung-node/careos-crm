import {
  Close_default
} from "./chunk-GPKAHAQ3.js";
import {
  ListSubheader_default
} from "./chunk-G2TPOU4V.js";
import {
  Chip_default,
  init_Chip
...
// node_modules/.pnpm/@material-ui+lab@4.0.0-alpha.61_@material-ui+core@4.12.4_@types+react@18.3.2_react-dom@18.3.1_hw6toyfrhgf2cldakmkelnm2lm/node_modules/@material-ui/lab/esm/Autocomplete/Autocomplete.js
init_objectWithoutProperties();
init_defineProperty();
init_extends();
...
// node_modules/.pnpm/@material-ui+lab@4.0.0-alpha.61_@material-ui+core@4.12.4_@types+react@18.3.2_react-dom@18.3.1_hw6toyfrhgf2cldakmkelnm2lm/node_modules/@material-ui/lab/esm/internal/svg-icons/ArrowDropDown.js
var React = __toESM(require_react());
init_utils();
var ArrowDropDown_default = createSvgIcon(React.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");

// node_modules/.pnpm/@material-ui+lab@4.0.0-alpha.61_@material-ui+core@4.12.4_@types+react@18.3.2_react-dom@18.3.1_hw6toyfrhgf2cldakmkelnm2lm/node_modules/@material-ui/lab/esm/useAutocomplete/useAutocomplete.js
init_extends();
init_slicedToArray();
init_typeof();
...
function useAutocomplete(props) {
  ...
  var ignoreFocus = React2.useRef(false);
  var firstFocus = React2.useRef(true);
  var inputRef = React2.useRef(null);
  var listboxRef = React2.useRef(null);
  var _React$useState = React2.useState(null), anchorEl = _React$useState[0], setAnchorEl = _React$useState[1];
  var _React$useState2 = React2.useState(-1), focusedTag = _React$useState2[0], setFocusedTag = _React$useState2[1];
  var defaultHighlighted = autoHighlight ? 0 : -1;
  var highlightedIndexRef = React2.useRef(defaultHighlighted);
  ...
  var _React$useState3 = React2.useState(false), focused = _React$useState3[0], setFocused = _React$useState3[1];
  ...
  var syncHighlightedIndex = React2.useCallback(function() {
    if (!popupOpen) {
      return;
    }
  ...
  var isTouch = React2.useRef(false);
...
function DisablePortal(props) {
  ...
  return React3.createElement("div", other);
}
var _ref = React3.createElement(Close_default, {
  fontSize: "small"
});
var _ref2 = React3.createElement(ArrowDropDown_default, null);
var Autocomplete = React3.forwardRef(function Autocomplete2(props, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map(function(option, index) {
        return React3.createElement(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push(React3.createElement("span", {
  ...
  var defaultRenderGroup = function defaultRenderGroup2(params) {
    return React3.createElement("li", {
      key: params.key
    }, React3.createElement(ListSubheader_default, {
      className: classes.groupLabel,
      component: "div"
    }, params.group), React3.createElement("ul", {
  ...
  var renderListOption = function renderListOption2(option, index) {
    ...
    return React3.createElement("li", _extends({}, optionProps, {
  ...
  return React3.createElement(React3.Fragment, null, React3.createElement("div", _extends({
    ref,
    ...
    InputProps: {
      ...
      startAdornment,
      endAdornment: React3.createElement("div", {
        className: classes.endAdornment
      }, hasClearIcon ? React3.createElement(IconButton_default, _extends({}, getClearProps(), {
        "aria-label": clearText,
        title: clearText,
        className: clsx_m_default(classes.clearIndicator, dirty && classes.clearIndicatorDirty)
      }), closeIcon) : null, hasPopupIcon ? React3.createElement(IconButton_default, _extends({}, getPopupIndicatorProps(), {
        disabled,
  ...
  })), popupOpen && anchorEl ? React3.createElement(PopperComponent, {
    ...
    anchorEl,
    open: true
  }, React3.createElement(PaperComponent, {
    className: classes.paper
  }, loading && groupedOptions.length === 0 ? React3.createElement("div", {
    className: classes.loading
  }, loadingText) : null, groupedOptions.length === 0 && !freeSolo && !loading ? React3.createElement("div", {
    className: classes.noOptions
  }, noOptionsText) : null, groupedOptions.length > 0 ? React3.createElement(ListboxComponent, _extends({
...
var Autocomplete_default = withStyles_default(styles, {
...
//# sourceMappingURL=chunk-NCNJBMUO.js.map
