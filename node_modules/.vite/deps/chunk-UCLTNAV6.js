...
// node_modules/.pnpm/@material-ui+core@4.12.4_@types+react@18.3.2_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@material-ui/core/esm/TablePagination/TablePagination.js
init_extends();
init_objectWithoutProperties();
...
// node_modules/.pnpm/@material-ui+core@4.12.4_@types+react@18.3.2_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@material-ui/core/esm/TablePagination/TablePaginationActions.js
init_extends();
init_objectWithoutProperties();
var React = __toESM(require_react());
var import_prop_types = __toESM(require_prop_types());
init_useTheme();
var _ref = React.createElement(KeyboardArrowRight_default, null);
var _ref2 = React.createElement(KeyboardArrowLeft_default, null);
var _ref3 = React.createElement(KeyboardArrowLeft_default, null);
var _ref4 = React.createElement(KeyboardArrowRight_default, null);
var TablePaginationActions = React.forwardRef(function TablePaginationActions2(props, ref) {
  ...
  return React.createElement("div", _extends({
    ref
  }, other), React.createElement(IconButton_default, _extends({
    onClick: handleBackButtonClick,
    disabled: page === 0,
    color: "inherit"
  }, backIconButtonProps), theme.direction === "rtl" ? _ref : _ref2), React.createElement(IconButton_default, _extends({
...
true ? TablePaginationActions.propTypes = {
   ...
   */
  onChangePage: import_prop_types.default.func,
  /**
   * Callback fired when the page is changed.
   *
   * @param {object} event The event source of the callback.
...
var TablePagination = React2.forwardRef(function TablePagination2(props, ref) {
  ...
  return React2.createElement(Component, _extends({
    ...
    colSpan,
    ref
  }, other), React2.createElement(Toolbar_default, {
    className: classes.toolbar
  }, React2.createElement("div", {
    className: classes.spacer
  }), rowsPerPageOptions.length > 1 && React2.createElement(Typography_default, {
    color: "inherit",
    variant: "body2",
    className: classes.caption,
    id: labelId
  }, labelRowsPerPage), rowsPerPageOptions.length > 1 && React2.createElement(Select_default, _extends({
    classes: {
      select: classes.select,
      icon: classes.selectIcon
    },
    input: React2.createElement(InputBase_default, {
    ...
    return React2.createElement(MenuItemComponent, {
    ...
    page
  })), React2.createElement(ActionsComponent, {
...
true ? TablePagination.propTypes = {
   ...
   */
  backIconButtonText: import_prop_types2.default.string,
  /**
   ...
   * For localization purposes, you can use the provided [translations](/guides/localization/).
   */
  nextIconButtonText: import_prop_types2.default.string,
  /**
   * Callback fired when the page is changed.
   *
   * @param {object} event The event source of the callback.
   ...
   */
  onChangePage: deprecatedPropType(import_prop_types2.default.func, "Use the `onPageChange` prop instead."),
  /**
   ...
   */
  onChangeRowsPerPage: deprecatedPropType(import_prop_types2.default.func, "Use the `onRowsPerPageChange` prop instead."),
  /**
   * Callback fired when the page is changed.
   *
   * @param {object} event The event source of the callback.
   ...
   * The zero-based index of the current page.
   */
  page: chainPropTypes(import_prop_types2.default.number.isRequired, function(props) {
   ...
   */
  rowsPerPageOptions: import_prop_types2.default.array,
  /**
   * Props applied to the rows per page [`Select`](/api/select/) element.
   */
  SelectProps: import_prop_types2.default.object
} : void 0;
var TablePagination_default = withStyles_default(styles, {
...
//# sourceMappingURL=chunk-UCLTNAV6.js.map
