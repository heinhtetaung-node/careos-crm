...
// node_modules/.pnpm/@material-ui+core@4.12.4_@types+react@18.3.2_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@material-ui/core/esm/TextField/TextField.js
init_extends();
init_objectWithoutProperties();
...
var TextField = React.forwardRef(function TextField2(props, ref) {
  ...
  return React.createElement(FormControl_default, _extends({
    ...
    color,
    variant
  }, other), label && React.createElement(InputLabel_default, _extends({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? React.createElement(Select_default, _extends({
    "aria-describedby": helperTextId,
    id,
    labelId: inputLabelId,
    value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && React.createElement(FormHelperText_default, _extends({
    id: helperTextId
...
var TextField_default = withStyles_default(styles, {
  name: "MuiTextField"
})(TextField);
...
//# sourceMappingURL=chunk-UZSTFFQQ.js.map
