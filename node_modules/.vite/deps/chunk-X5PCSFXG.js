...
function CustomMediaMixin(superclass, { tag, is }) {
  var _a, _b, _c, _isDefined, _CustomMedia_static, define_fn, _isInit, _nativeEl, _childMap, _childObserver, _slotChangeHandler, _CustomMedia_instances, init_fn, setupListeners_fn, syncMediaChildren_fn, syncMediaChildAttribute_fn, enableDefaultTrack_fn, upgradeProperty_fn, forwardAttribute_fn;
  ...
  return _c = class extends superclass {
    constructor() {
      ...
      __privateAdd(this, _slotChangeHandler);
    ...
    init() {
      ...
      __privateMethod(this, _CustomMedia_instances, setupListeners_fn).call(this);
    }
    handleEvent(event) {
    ...
    connectedCallback() {
      __privateMethod(this, _CustomMedia_instances, init_fn).call(this);
      if (!__privateGet(this, _slotChangeHandler)) {
        __privateMethod(this, _CustomMedia_instances, setupListeners_fn).call(this);
      }
    }
    disconnectedCallback() {
      var _a2, _b2, _c2;
      (_a2 = __privateGet(this, _childObserver)) == null ? void 0 : _a2.disconnect();
      __privateSet(this, _childObserver, void 0);
      if (__privateGet(this, _slotChangeHandler)) {
        (_b2 = this.shadowRoot) == null ? void 0 : _b2.removeEventListener("slotchange", __privateGet(this, _slotChangeHandler));
        __privateSet(this, _slotChangeHandler, void 0);
      }
      for (const type of this.constructor.Events) {
        (_c2 = this.shadowRoot) == null ? void 0 : _c2.removeEventListener(type, this, true);
      }
      __privateGet(this, _childMap).forEach((clone) => clone.remove());
      __privateGet(this, _childMap).clear();
      __privateSet(this, _nativeEl, null);
    }
  ...
  }, _isInit = new WeakMap(), _nativeEl = new WeakMap(), _childMap = new WeakMap(), _childObserver = new WeakMap(), _slotChangeHandler = new WeakMap(), _CustomMedia_instances = new WeakSet(), init_fn = function() {
    ...
    __privateSet(this, _slotChangeHandler, () => __privateMethod(this, _CustomMedia_instances, syncMediaChildren_fn).call(this));
    (_a2 = this.shadowRoot) == null ? void 0 : _a2.addEventListener("slotchange", __privateGet(this, _slotChangeHandler));
    __privateMethod(this, _CustomMedia_instances, syncMediaChildren_fn).call(this);
    for (const type of this.constructor.Events) {
      (_b2 = this.shadowRoot) == null ? void 0 : _b2.addEventListener(type, this, true);
    }
...
function removeVideoTrack(track) {
  var _a, _b;
  const trackList = (_b = (_a = getPrivate(track).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.videoTracks;
  if (!trackList) return;
  const trackSet = getPrivate(trackList).trackSet;
...
function selectedChanged(selected) {
  var _a, _b;
  const trackList = ((_b = (_a = getPrivate(selected).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.videoTracks) ?? [];
...
function addRendition(track, rendition) {
  var _a, _b;
  const renditionList = (_b = (_a = getPrivate(track).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.videoRenditions;
...
function removeRendition(rendition) {
  var _a, _b;
  const renditionList = (_b = (_a = getPrivate(rendition).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.videoRenditions;
...
function getCurrentRenditions(renditionList) {
  var _a;
  const media = (_a = getPrivate(renditionList).media) == null ? void 0 : _a.deref();
  if (!media) return [];
...
function addRendition2(track, rendition) {
  var _a, _b;
  const renditionList = (_b = (_a = getPrivate(track).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.audioRenditions;
  getPrivate(rendition).media = getPrivate(track).media;
  getPrivate(rendition).track = track;
  const renditionSet = getPrivate(track).renditionSet;
  renditionSet.add(rendition);
...
function removeRendition2(rendition) {
  var _a, _b;
  const renditionList = (_b = (_a = getPrivate(rendition).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.audioRenditions;
  const track = getPrivate(rendition).track;
  const renditionSet = getPrivate(track).renditionSet;
  renditionSet.delete(rendition);
  queueMicrotask(() => {
...
function removeAudioTrack(track) {
  var _a, _b;
  const trackList = (_b = (_a = getPrivate(track).media) == null ? void 0 : _a.deref()) == null ? void 0 : _b.audioTracks;
  if (!trackList) return;
  const trackSet = getPrivate(trackList).trackSet;
  trackSet.delete(track);
  queueMicrotask(() => {
...
//# sourceMappingURL=chunk-X5PCSFXG.js.map
