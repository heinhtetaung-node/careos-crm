...
// node_modules/.pnpm/downshift@8.5.0_react@18.3.1/node_modules/downshift/dist/downshift.esm.js
init_objectWithoutPropertiesLoose();
init_extends();
init_assertThisInitialized();
init_inheritsLoose();
...
function getA11ySelectionMessage(selectionParameters) {
  var selectedItem = selectionParameters.selectedItem, itemToString2 = selectionParameters.itemToString;
  return selectedItem ? itemToString2(selectedItem) + " has been selected." : "";
}
...
function getHighlightedIndexOnOpen(props, state, offset) {
  var items = props.items, initialHighlightedIndex = props.initialHighlightedIndex, defaultHighlightedIndex = props.defaultHighlightedIndex, itemToKey2 = props.itemToKey;
...
function useA11yMessageSetter(getA11yMessage, dependencyArray, _ref3) {
  var highlightedIndex = _ref3.highlightedIndex, items = _ref3.items, environment = _ref3.environment, rest = _objectWithoutPropertiesLoose(_ref3, _excluded$3);
...
if (true) {
  useControlPropsValidator = function useControlPropsValidator2(_ref5) {
    var props = _ref5.props, state = _ref5.state;
...
var propTypes$2 = __assign(__assign({}, commonDropdownPropTypes), { items: import_prop_types.default.array.isRequired, isItemDisabled: import_prop_types.default.func, getA11ySelectionMessage: import_prop_types.default.func });
...
function useSelect(userProps) {
  ...
  var mouseAndTouchTrackers = useMouseAndTouchTracker(environment, [toggleButtonRef, menuRef], (0, import_react.useCallback)(function handleBlur() {
...
function useControlledReducer(reducer, props, createInitialState, isStateEqual2) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    if (!isInitialMount) {
      ...
      if (props.selectedItemChanged === void 0) {
...
function useCombobox(userProps) {
  ...
  var items = props.items, scrollIntoView2 = props.scrollIntoView, environment = props.environment, getA11yStatusMessage2 = props.getA11yStatusMessage, getA11ySelectionMessage2 = props.getA11ySelectionMessage, itemToString2 = props.itemToString;
  ...
  var mouseAndTouchTrackers = useMouseAndTouchTracker(environment, [toggleButtonRef, menuRef, inputRef], (0, import_react.useCallback)(function handleBlur() {
    if (latest.current.state.isOpen) {
      dispatch({
        type: InputBlur,
        selectItem: false
