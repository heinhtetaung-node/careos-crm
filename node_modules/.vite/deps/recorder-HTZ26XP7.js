...
// node_modules/.pnpm/@newrelic+rrweb@1.0.1/node_modules/@newrelic/rrweb/dist/rrweb.js
...
function isShadowRoot(n2) {
  const hostEl = n2 && "host" in n2 && "mode" in n2 && index$1.host(n2) || null;
...
function is2DCanvasBlank(canvas) {
  ...
  for (let x2 = 0; x2 < canvas.width; x2 += chunkSize) {
    for (let y = 0; y < canvas.height; y += chunkSize) {
      ...
      const pixelBuffer = new Uint32Array(originalGetImageData.call(ctx, x2, y, Math.min(chunkSize, canvas.width - x2), Math.min(chunkSize, canvas.height - y)).data.buffer);
    ...
    for (let i2 = 1; i2 < childNodes2.length; i2++) {
      if (childNodes2[i2].textContent && typeof childNodes2[i2].textContent === "string") {
        ...
        for (; j < textContentNorm.length; j++) {
          if (textContentNorm[j].match(/[a-zA-Z0-9]/) || textContentNorm.indexOf(textContentNorm.substring(0, j), 1) !== -1) {
            continue;
          }
          break;
        }
...
var __publicField22 = (obj, key, value) => __defNormalProp2(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var BaseRRNode = class _BaseRRNode {
  constructor(..._args) {
    ...
    __publicField22(this, "ELEMENT_NODE", NodeType$2.ELEMENT_NODE);
    __publicField22(this, "TEXT_NODE", NodeType$2.TEXT_NODE);
...
// node_modules/.pnpm/@newrelic+browser-agent@1.306.0/node_modules/@newrelic/browser-agent/dist/esm/features/session_replay/shared/recorder-events.js
var _events;
var RecorderEvents = class {
  constructor(shouldInlineStylesheets = true) {
    /** The buffer to hold recorder event nodes */
    __privateAdd(this, _events, new EventBuffer(Infinity));
    /** Payload metadata -- Should indicate when a replay blob started recording.  Resets each time a harvest occurs.
       * cycle timestamps are used as fallbacks if event timestamps cannot be used
       */
    __publicField(this, "cycleTimestamp", Date.now());
    ...
    */
    __publicField(this, "hasSnapshot", false);
    ...
    __publicField(this, "hasMeta", false);
  ...
  add(event, evaluatedSize) {
    __privateGet(this, _events).add(event, evaluatedSize);
  }
  get events() {
    return __privateGet(this, _events).get();
  }
  /** A value which increments with every new mutation node reported. Resets after a harvest is sent */
  get payloadBytesEstimation() {
    return __privateGet(this, _events).byteSize();
  }
};
_events = new WeakMap();

// node_modules/.pnpm/@newrelic+browser-agent@1.306.0/node_modules/@newrelic/browser-agent/dist/esm/features/session_replay/shared/recorder.js
var RRWEB_DATA_CHANNEL = "rrweb-data";
var _fixing, _warnCSSOnce, _canRecord;
var Recorder = class {
  ...
  constructor(srInstrument) {
    ...
    __privateAdd(this, _fixing, false);
    __privateAdd(this, _warnCSSOnce, single(() => warn(47)));
    // notifies user of potential replayer issue if fix_stylesheets is off
    __privateAdd(this, _canRecord, true);
    __publicField(this, "triggerHistory", []);
    var _a2;
    ...
    defaultRegister(SESSION_ERROR, () => {
      __privateSet(this, _canRecord, false);
      this.stopRecording();
    }, this.srFeatureName, this.ee);
    const processReplayNode = (event, isCheckout) => {
      this.audit(event, isCheckout);
    };
    if ((_a2 = this.srInstrument.featAggregate) == null ? void 0 : _a2.drained) this.ee.on(RRWEB_DATA_CHANNEL, processReplayNode);
  ...
  startRecording(trigger, mode) {
    if (!__privateGet(this, _canRecord)) return;
  ...
  audit(event, isCheckout) {
    ...
    if (!this.shouldFix) {
      if (incompletes > 0) {
        ...
        __privateGet(this, _warnCSSOnce).call(this);
    ...
    if (!incompletes && __privateGet(this, _fixing) && event.type === RRWEB_EVENT_TYPES.Meta) __privateSet(this, _fixing, false);
    if (incompletes > 0) {
      ...
      if (event.type === RRWEB_EVENT_TYPES.FullSnapshot || event.type === RRWEB_EVENT_TYPES.Meta) __privateSet(this, _fixing, true);
    }
    if (!__privateGet(this, _fixing)) this.store(event, isCheckout);
  }
  /** Store a payload in the buffer (this.events).  This should be the callback to the recording lib noticing a mutation */
  store(event, isCheckout) {
    var _a2, _b, _c;
    if (!event || ((_a2 = this.srInstrument.featAggregate) == null ? void 0 : _a2.blocked)) return;
    ...
    this.hasSeenMeta || (this.hasSeenMeta = (_b = this.events).hasMeta || (_b.hasMeta = event.type === RRWEB_EVENT_TYPES.Meta));
    this.hasSeenSnapshot || (this.hasSeenSnapshot = (_c = this.events).hasSnapshot || (_c.hasSnapshot = event.type === RRWEB_EVENT_TYPES.FullSnapshot));
  ...
  estimateCompression(data) {
    var _a2, _b;
    if (!!((_a2 = this.srInstrument.featAggregate) == null ? void 0 : _a2.gzipper) && !!((_b = this.srInstrument.featAggregate) == null ? void 0 : _b.u8)) return data * AVG_COMPRESSION;
    return data;
  }
};
_fixing = new WeakMap();
_warnCSSOnce = new WeakMap();
_canRecord = new WeakMap();
export {
  Recorder
};
...
@newrelic/rrweb/dist/rrweb.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=recorder-HTZ26XP7.js.map
