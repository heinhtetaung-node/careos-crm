...
function CreditCardInstallmentSection({
  ...
  const [selectedBank, setSelectedBank] = useState(
    creditCardPaymentData.cardProviders[0].name
  );
  ...
  return (
    <TableData
      paymentOption={getString(`paymentOptions.CREDIT_CARD_INSTALLMENT`)}
      action={<ActionSection />}
      dataTestId="creditCardInstallment-section"
    >
      <div className="grid text-center gap-1 w-full">
...
export default CreditCardInstallmentSection;
